...
public class DateUtils {
     ...
     */
    public static String formatTime(Date timeInMillis) {
     ...
     */
    public static String formatDateTime(Date timeInMillis) {
     ...
     */
    public static String formatDate(Date timeInMillis) {
     ...
     */
    public static boolean isToday(Date timeInMillis) {
     ...
     */
    public static boolean hasSameDate(Date millisFirst, Date millisSecond) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd", Locale.getDefault());
